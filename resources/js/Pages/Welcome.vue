...
<template>
    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="mt-16">
                <p class="text-white text-2xl">Please 
                    <a href="/login" class="text-blue-300">login</a>  or go to 
                    <a href="/dashboard" class="text-blue-300">dashboard</a> to view assessment, you can use the login details below:</p>
            </div>

            <div class="mt-16">
                <p class="text-white">u: manager</p>
                <p class="text-white">pw: password</p>
            </div>

            <div class="mt-16">
                <p class="text-white">u: web_developer</p>
                <p class="text-white">pw: password</p>
            </div>

            <div class="mt-16">
                <p class="text-white">u: web_designer</p>
                <p class="text-white">pw: password</p>
            </div>
